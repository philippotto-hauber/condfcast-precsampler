...
- inflation nowcasts from the Reuters Poll are slightly less accurate as the model's unconditional forecast and outperform the benchmark but by a much smaller margin than in the case of GDP
