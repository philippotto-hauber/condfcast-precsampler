...
In this Appenix, we list the data series used in the empirical application, their source as well as any transformation applied to the series prior to estimation. 
...
\begin{longtable}{| l | c | c | c | l | l |} 
    ...
    \hline
    gross domestic product, chain index\textsuperscript{sc} & gdp &  nat. accounts, expenditure & log, diff  & Bundesbank RTD & Code: BBKRT.Q.DE.Y.A.AG1.CA010.A.I  \\ \hline 
    gross domestic product, deflator\textsuperscript{sc} & p\_gdp &  nat. accounts, expenditure &  log, diff  & Bundesbank RTD & implicit deflator, i.e. nominal series divided by chain index  \\ \hline 
    private consumption expenditure, chain index\textsuperscript{sc} & c &  nat. accounts, expenditure &  log, diff  & Bundesbank RTD & Code: BBKRT.Q.DE.Y.A.CA1.BA100.A.I  \\ \hline 
    private consumption expenditure, deflator\textsuperscript{sc} & p\_c &  nat. accounts, expenditure &  log, diff  & Bundesbank RTD & implicit deflator, i.e. nominal series divided by chain index  \\ \hline 
    foo & bar \\ \hline
    foo & bar \\ \hline
    foo & bar \\ \hline
    foo & bar \\ \hline
