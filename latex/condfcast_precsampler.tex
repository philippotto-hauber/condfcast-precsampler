...
\begin{longtable}{| l | c | l | l | l | l |} 
    ...
    gross domestic product, deflator\tnote{s, c} & p\_gdp &  nat. accounts, expenditure &  log, diff  & Bundesbank RTD & implicit deflator, i.e. nominal series divided by chain index  \\ \hline 
