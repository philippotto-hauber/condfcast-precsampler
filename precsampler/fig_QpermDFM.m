% this code produces the figure fig_Qperm_DFM.pdf' and stores it in the
% figures dir. Prior to executing these lines, run simul(71) (HS sampler,
% conditional forecast) and set a breakpoint in construct_PQP.m at line 49!
...
print('../figures/fig_Qperm_DFM.pdf','-dpdf','-fillpage') ; 